...
public class MissionUIManager : MonoBehaviour
{
    ...
    {
        if (t1 != null) { t1.text = o1; t1.color = Color.cyan; }
        if (t2 != null) { t2.text = o2; t2.color = Color.cyan; }
        if (t3 != null) { t3.text = o3; t3.color = Color.cyan; }
    }
                    ...
                    string o1, string o2, string o3, string o4)
    {
        ...
        if (t2 != null) { t2.text = o2; t2.color = Color.cyan; }
        if (t3 != null) { t3.text = o3; t3.color = Color.cyan; }
        if (t4 != null) { t4.text = o4; t4.color = Color.cyan; }
    }
}
